...
function level_1() {
    ...
    function check(ss, s) {
        if (stair == s) {
            sound.play("OOO.mp3?r=" + random)
            ss.destroy()
            stair += 1
        } else {
            sound.play("XXX.mp3?r=" + random)
        }
    }
